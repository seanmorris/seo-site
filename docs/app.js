...
var Header = /*#__PURE__*/function (_View) {
  ...
  function Header(args, parent) {
    ...
    _this.listen(document, 'transitionend', function (event) {
      return _this.afterTransition(event);
    });
  ...
  _createClass(Header, [{
    ...
    value: function toggleMenu(event) {
      var _document$body$parent = document.body.parentElement,
          scrollTop = _document$body$parent.scrollTop,
          clientWidth = _document$body$parent.clientWidth;
      this.args.menuOpen = !this.args.menuOpen;

      if (this.args.menuOpen) {
        document.body.parentElement.classList.add('menu-open');
        document.body.scrollTop = scrollTop;
        var newClientWidth = document.body.parentElement.clientWidth;
    ...
    key: "afterTransition",
    value: function afterTransition(event) {
...
require.register("Splash.js", function(exports, require, module) {
"use strict";
...
var Splash = /*#__PURE__*/function (_View) {
  _inherits(Splash, _View);
  ...
  function Splash() {
    ...
    var lastSplash = localStorage.getItem('cv-sm-last-splash');

    if (!args.force && new Date().getTime() - lastSplash < 0) {
      _this.args.animation = 'done';

      _this.onTimeout(0, function () {
        _this.remove();
      });
    ...
    _this.args.fade = 1;
    _this.args.frame = 0;
    _this.args.fullFade = 1;
    _this.args.pointerEvents = 'all';
    _this.args.animation = 'hide';

    _this.onTimeout(100, function () {
      _this.args.animation = 'slide';
    });

    _this.onTimeout(750, function () {
      _this.args.animation = 'show';
    });

    _this.onTimeout(2000, function () {
      _this.args.animation = 'done';
    });

    _this.onTimeout(2750, function () {
      _this.remove();
    });
...
;require.register("contact.html", function(exports, require, module) {
module.exports = "<h4>contact me</h4>\n\n<form id = \"contact\">\n  <label>\n    <span>name</span>\n    <input type = \"text\">\n  </label>\n\n  <label>\n    <span>business name</span>\n    <input type = \"text\">\n  </label>\n\n  <label>\n    <span>business type</span>\n    <input type = \"text\">\n  </label>\n\n  <label>\n    <span>email</span>\n    <input type = \"text\">\n  </label>\n\n  <label>\n    <span>phone</span>\n    <input type = \"text\">\n  </label>\n\n  <label>\n    <input type = \"button\" value = \"submit\">\n  </label>\n\n</form>\n"
});
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var footer = _View.View.from(require('./footer.html'));

  var contact = _View.View.from(require('./contact.html'));

  home.args.contactOffset = 0;
  home.args.contact = contact;

  home.contact = function (event) {
    window.scrollTo({
      top: 0,
      left: 0,
      behavior: 'smooth'
